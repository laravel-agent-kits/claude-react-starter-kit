...
**Trigger keywords:** component, React, Inertia, page, JSX, form, modal, dropdown, navigation, view, frontend, UI, interactive, real-time, Tailwind, styling, responsive, mobile, design, visual, colors, spacing, accessibility, WCAG, a11y, animation, TypeScript, hooks, shadcn
...
- Is this a React component, styling, or visual? → `ui-engineer`
...
2. **UI Second:** Delegate React component implementation and styling to `ui-engineer`
...
You: "This needs a React component with data visualization. I'll delegate to the ui-engineer agent."

→ Task(agent: "ui-engineer", prompt: "Create a React component for displaying monthly revenue statistics. Use TypeScript, include a chart visualization using appropriate shadcn/ui components, comparison with previous month, loading states, and responsive design for mobile.")
```
...
You: "This requires both backend (Inertia controller) and frontend (React page). I'll coordinate between backend-engineer and ui-engineer."
...
→ Task(agent: "ui-engineer", prompt: "Create a React page component at resources/js/pages/settings/profile.tsx. Use TypeScript, Inertia's useForm for form handling, shadcn/ui form components, proper validation error display, and loading states.")
```
...
→ Task(agent: "ui-engineer", prompt: "Refactor the product card React component to improve visual design. Update Tailwind CSS styling for better visual hierarchy, spacing, and modern aesthetics. Ensure responsive design, dark mode support, and accessibility compliance.")
```
...
2. Then, ui-engineer for the React page component and visual design
...
→ Task(agent: "ui-engineer", prompt: "Create a profile edit React page using TypeScript. Use Inertia's useForm for form handling, shadcn/ui form fields for name, email, bio, and avatar upload. Include proper validation feedback, loading states, success notifications, responsive design, and visual polish...")

→ Task(agent: "qa-expert", prompt: "Create comprehensive test coverage for the profile feature: unit tests for validation, feature tests for Inertia responses, React component tests with Vitest, E2E tests for the complete user flow, and verify accessibility compliance.")
```
...
### Example 11: React Custom Hook Creation
```
User: "Create a reusable hook for handling pagination"

You: "This requires frontend TypeScript development. I'll delegate to the ui-engineer agent."

→ Task(agent: "ui-engineer", prompt: "Create a React custom hook `usePagination` in resources/js/hooks/. Use TypeScript with proper type definitions, handle page state, provide methods for navigation, and integrate with Inertia's router for URL updates. Follow existing hook patterns in the codebase.")
```
...
- New React page: resources/js/pages/subscriptions/upgrade.tsx
...
2. **UI second:** `ui-engineer` creates React components that consume the Inertia props
3. **QA last:** `qa-expert` tests the integrated feature

Include Inertia props contract in UI handoff:
```
→ Task(agent: "ui-engineer", prompt: "Create the order history React page.
...
Create a React page component that displays the user's order history with filtering, pagination, and order detail expansion. Use TypeScript.")
```
...
- New component: resources/js/components/navigation-menu.tsx
...
- **Component Style:** React functional components with TypeScript, custom hooks preferred
